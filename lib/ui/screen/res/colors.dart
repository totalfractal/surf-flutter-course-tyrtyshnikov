...
final lmGreenColor = Color.fromRGBO(76, 175, 80, 1);
final lmYellowColor = Color.fromRGBO(252, 221, 61, 1);
final lmRedColor = Color.fromRGBO(239, 67, 67, 1);
final lmWhiteColor = Color.fromRGBO(255, 255, 255, 1);
final lmMainColor = Color.fromRGBO(37, 40, 73, 1);
final lmSecondaryColor = Color.fromRGBO(59, 62, 91, 1);
final lmSecondary2Color = Color.fromRGBO(124, 126, 146, 1);
final lmInactiveBlackColor = Color.fromRGBO(124, 126, 146, 0.56);
final lmGreyColor = Color.fromRGBO(245, 245, 245, 1);
...
final dmGreenColor = Color.fromRGBO(106, 218, 111, 1);
final dmYellowColor = Color.fromRGBO(255, 231, 105, 1);
final dmRedColor = Color.fromRGBO(207, 42, 42, 1);
final dmWhiteColor = Color.fromRGBO(255, 255, 255, 1);
final dmDarkColor = Color.fromRGBO(26, 26, 32, 1);
final dmMainColor = Color.fromRGBO(33, 34, 44, 1);
final dmSecondaryColor = Color.fromRGBO(59, 62, 91, 1);
final dmSecondary2Color = Color.fromRGBO(124, 126, 146, 1);
final dmInactiveBlackColor = Color.fromRGBO(124, 126, 146, 0.56);
